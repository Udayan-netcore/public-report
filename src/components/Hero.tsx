...
const Hero = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-goa-sea/90 to-goa-sea">
      {/* Background pattern */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className="text-center md:text-left md:max-w-2xl animate-fade-in" style={{ animationDelay: '200ms' }}>
          ...
          <p className="text-lg text-white/80 mb-8 max-w-lg mx-auto md:mx-0">
            Join us for two days of learning, collaboration, and fun at our annual tech team offsite in beautiful Goa!
          </p>
          
          <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-3 sm:space-y-0 sm:space-x-4">
            <Button 
              onClick={scrollToSchedule}
              className="bg-white text-goa-sea hover:bg-white/90"
            >
              View Schedule
            </Button>
          </div>
